# -*- coding: utf-8 -*-
#==============================================================================
# ** scripts-compiler v1.1.0 - RMXP Adaptation
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
# Compile scripts from the given folder to "Scripts.rxdata", in the same place
# as this one. See the README.md on the original GitHub!
#==============================================================================
...
module XT_CONFIG
    ...
    COMPILE_FROM = Dir.pwd + "/Scripts"  # Compile the scripts from the folder you want.
  ...
  # ** Compiler
  #------------------------------------------------------------------------------
  #  Compile scripts from the "Scripts" folder, to the "Scripts.rxdata"
  #==============================================================================
   ...
   (a backup for \"#{SCRIPTS}\" will be created)"
    ...
    def open_rxdata
      ...
      @scripts.each_with_index do |script, i|
        @depth = 2 if script[1] == XT_CONFIG::CATEGORY_STR + " Modules"
    ...
    def add_category(name)
      ...
      if @depth == 2
        name.insert(0, XT_CONFIG::CATEGORY_STR + ' ')
        add_script("", "")
        add_script(name, "")
      else
        @depth -= 1
        name.insert(0, XT_CONFIG::SUBCATEGORY_STR + ' ')
        add_script(name, "")
        @depth += 1
      end
    end
    ...
    def the_end
      ...
      print "All scripts compiled into \"#{SCRIPTS}\"! \\o/
