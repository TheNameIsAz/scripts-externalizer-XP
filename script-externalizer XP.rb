# -*- coding: utf-8 -*-
#==============================================================================
# ** scripts-externalizer v1.1.0 - RMXP Adaptation
#------------------------------------------------------------------------------
...
# Added category & subcategory identifiers allowing you to customise as you want
#------------------------------------------------------------------------------
# Externalize all scripts from "Data/Scripts.rxdata" to the given folder
# See the README.md on the original GitHub!
#==============================================================================
...
module XT_CONFIG
    ...
    CATEGORY_STR =    "#>"  # Category Identifier (empty script with a category title) 
    SUBCATEGORY_STR = "~>"  # Subcategory Identifier (empty script with a subcategory title)
  end
  ...
  module Externalizer
    ...
    extend self
    #--------------------------------------------------------------------------
    # * Get Scripts.rxdata path from Game.ini
    #--------------------------------------------------------------------------
    filename = './Game.ini'
    section = 'Game'
    key = 'Scripts'
   ...
   (a backup for \"#{SCRIPTS}\" will be created)"
    ...
    def the_end
      ...
      print "All scripts externalized to \"#{XT_CONFIG::EXTRACT_TO}\" folder! \\o/
  ...
  "# -*- coding: utf-8 -*-
  #==============================================================================
  # ** ORMS Converter v1.1.0 - RMXP Adaptation
  #------------------------------------------------------------------------------
  # By Joke @biloumaster <joke@biloucorp.com>
  # GitHub: https://github.com/RMEx/scripts-externalizer
  #------------------------------------------------------------------------------
  ...
  module XT_CONFIG
    ...
    LOAD_FROM = Dir.pwd + \"/#{XT_CONFIG::EXTRACT_TO}\"  # Load the scripts from the folder you want.
                             # Can be \"C:/.../MyScripts/\" or \"../../MyScripts/\"
